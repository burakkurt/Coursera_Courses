...
public class EarthquakeCityMap extends PApplet{
	...
	public void setup() {
	    ...
	    for(int index=0;index < earthquakes.size();index++) {
	    	PointFeature feature = earthquakes.get(index);
	...
	private SimplePointMarker createMarker(PointFeature feature)
	{
		...
		if(Float.parseFloat(feature.getProperty("magnitude").toString()) < 4.0){
			...
			simplePointMarker.setColor(color(42,106,255));
		}
		else if(Float.parseFloat(feature.getProperty("magnitude").toString()) <= 4.9 && Float.parseFloat(feature.getProperty("magnitude").toString()) >= 4.0){
