...
public class CityMarker extends SimplePointMarker {
	...
	public void draw(PGraphics pg, float x, float y) {
		...
		SimplePointMarker simplePointMarker = new SimplePointMarker();
		simplePointMarker.setColor(pg.color(255,0,0));
		simplePointMarker.setLocation(x, y);
		pg.color(255,0,0);
		pg.fill(255,0,0);
		pg.triangle(x, y, x+7, y-8, x+14, y);
		//simplePointMarker.draw(pg, x, y);
