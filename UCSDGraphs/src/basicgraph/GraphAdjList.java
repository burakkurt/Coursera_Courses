...
public class GraphAdjList extends Graph {
	 ...
	 */		
	 public List<Integer> getDistance2(int v) {
		 ...
		 List<Integer> neighborList2 = new ArrayList<Integer>();
		 List<Integer> neighborList = getNeighbors(v);
		 
		 for(Integer neighbors:neighborList){
			 List<Integer> tempNeighborList = getNeighbors(neighbors);
			 for(Integer neighbors2:tempNeighborList){
				 neighborList2.add(neighbors2);
			 }
		 }
